...
require_once('library/portfolio-project.php'); // custom post type example
require_once('library/people.php');
...
/*Fix custom post type menu problem,
where current_post_parent doesn't get added*/
...
function change_page_menu_classes($menu){
	if (get_post_type() == 'portfolio_project') {
		...
		$menu = str_replace( 'menu-item-17', 'menu-item-17 current_page_parent', $menu ); 
	}
	return $menu;
}
add_filter( 'nav_menu_css_class', 'change_page_menu_classes', 0 );
